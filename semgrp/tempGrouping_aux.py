...
# the input file is a template description file having the following format:
# - id
# - template
# - example
# For example one template in the file could be:
# 20000
# normal 
# 2560330,gige7,gige,temperature,1073217400,1,normal
